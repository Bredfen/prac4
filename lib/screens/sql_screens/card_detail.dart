...
class _CardDetailState extends State<CardDetail> {
  ...
  Widget build(BuildContext context) {
    if (widget.pos != null) {
      ...
      log(picture.toString());
    }

    return Scaffold(
      appBar: AppBar(
        title: Text(widget.pos == null ? 'Добавить' : 'Редактировать', style: TextStyle( fontWeight: FontWeight.bold, fontFamily: "PricedownBl")),
        centerTitle: true,
      ),
      body: Padding(
          ...
          children: [
            ...
            Padding(
              ...
              child: ElevatedButton(
                ...
                child: const Text("Картинка", style: TextStyle( fontWeight: FontWeight.bold, fontFamily: "PricedownBl"),),
              ),
            ),
            const Spacer(),
            Padding(
